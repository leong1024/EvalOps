...
class ProjectConfig:
    ...
    def _read_bundled_defaults() -> dict:
        ...
        typically located at <root>/evalops/config.toml in the evalops.bot distribution.
        Returns:
    ...
    def load(config_path: str | Path | None = None) -> "ProjectConfig":
        ...
        (<current_project>/.evalops/config.toml).
        ...
        if config_path.exists():
            logging.info(
                f"Loading project-specific configuration from {file_link(config_path)}..."
            )
