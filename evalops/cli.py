...
@app.callback(
    ...
    help="\bEvalOps is an open-source AI code reviewer that works with any language model provider."
...
@app.command(
    ...
    "\nMight be useful to check what will be reviewed if run `evalops review` "
